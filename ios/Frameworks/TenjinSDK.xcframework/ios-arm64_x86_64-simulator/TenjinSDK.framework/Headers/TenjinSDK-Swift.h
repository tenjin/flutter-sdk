...
- (void)handlePostRequestWithEndpoint:(NSString * _Nonnull)endpoint params:(NSDictionary<NSString *, id> * _Nonnull)params apiVersion:(NSString * _Nonnull)apiVersion;
...
@property (nonatomic, readonly, strong) TenjinImpl * _Nonnull apiClient;
